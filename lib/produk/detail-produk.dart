...
import 'package:lgp/produk/api-detail-produk.dart';
...
class DetailProduk extends StatefulWidget {
  ...
  final String judul;
  const DetailProduk(
      {Key? key, required this.id, required this.jenis, required this.judul})
      : super(key: key);
...
class _DetailProdukState extends State<DetailProduk>
  ...
  late Future<List<ApiDetailProduk>> _detail;
  ...
  void initState() {
    ...
    _detail = fetchDetailProduk(widget.jenis, widget.id, widget.judul);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            FutureBuilder<List<ApiDetailProduk>>(
              future: _detail,
              builder: (ctx, snapshot) {
                if (snapshot.hasData) {
                  List<ApiDetailProduk>? data = snapshot.data;
